...
msg-auth_logout-success = Abgemeldet von: {$username}@{$host}
...
msg-actions-dispatch-success = Workflow {$name} in {$ref} mit {$n_inputs ->
        [one] 1 Input
...
msg-org-create-success = Neue {$visibility ->
        [public] öffentliche
        [limited] begrenzte
       *[private] private
...
msg-org-team-view = {STYLE("bright-blue", "bold")}{$name}{STYLE("reset")} in Organisation {STYLE("bold")}{$org}{STYLE("reset")} {$admin ->
...
msg-org-team-create-success = Neues {$admin ->
        [yes] Adminteam
       *[no] Team
...
msg-org-team-repo-add-success =
    {STYLE("bold")}{$org}/{$repo}{STYLE("reset")} zu Team {STYLE("bold", "bright_blue")}{$team}{STYLE("reset")} hinzugefügt.

msg-org-team-repo-rm-success =
    {STYLE("bold")}{$org}/{$repo}{STYLE("reset")} von Team {STYLE("bold", "bright_blue")}{$team}{STYLE("reset")} entfernt.
...
msg-org-team-member-add-success =
    {STYLE("bold")}{$user}{STYLE("reset")} zu Team {STYLE("bold", "bright_blue")}{$team}{STYLE("reset")} hinzugefügt.

msg-org-team-member-rm-success =
    {STYLE("bold", "bright-cyan")}{$user}{STYLE("reset")} von Team {STYLE("bold", "bright_blue")}{$team}{STYLE("reset")} entfernt.
...
msg-pr-review-list-comment_header = {STYLE("bold", "bright-cyan")}{$commenter}{STYLE("reset")} kommentierte {OPT($resolver) ->
       *[none] {""}
...
msg-pr-checkout-success = PR #{$number} ausgecheckt: {$title}
    {$new_branch ->
...
msg-user-gpg-list-can_sign = {STYLE("bold")}Kann signieren:{STYLE("reset")}                   {$can_sign ->
        [yes] {STYLE("bright-green")}true{STYLE("reset")}
       *[no] {STYLE("bright-red")}false{STYLE("reset")}
    }
msg-user-gpg-list-can_encrypt_comms = {STYLE("bold")}Kann Kommunikation verschlüsseln:{STYLE("reset")} {$can_encrypt_comms ->
        [yes] {STYLE("bright-green")}true{STYLE("reset")}
       *[no] {STYLE("bright-red")}false{STYLE("reset")}
    }
msg-user-gpg-list-can_encrypt_storage = {STYLE("bold")}Kann Speicher verschlüsseln:{STYLE("reset")}      {$can_encrypt_storage ->
        [yes] {STYLE("bright-green")}true{STYLE("reset")}
       *[no] {STYLE("bright-red")}false{STYLE("reset")}
    }
msg-user-gpg-list-can_certify = {STYLE("bold")}Kann zertifizieren:{STYLE("reset")}               {$can_certify ->
        [yes] {STYLE("bright-green")}true{STYLE("reset")}
       *[no] {STYLE("bright-red")}false{STYLE("reset")}
    }
msg-user-gpg-list-verified = {STYLE("bold")}Verifiziert:{STYLE("reset")}                      {$verified ->
        [yes] {STYLE("bright-green")}true{STYLE("reset")}
       *[no] {STYLE("bright-red")}false{STYLE("reset")}
    }
...
msg-user-gpg-upload-export_failed = Schlüsselexport fehlgeschlagen. {OPT($status_code) ->
       *[none] {""}
...
msg-user-gpg-verify-signing_failed = Verifizierungstoken konnte nicht signiert werden. {OPT($status_code) ->
       *[none] {""}
        [some] GPG Status: {$status_code}
    }
...
msg-user-gpg-delete-confirmation_prompt =
        Das Löschen eines GPG Schlüssels führt dazu, dass alle mit diesem Schlüssel signierten Commits ihre Verifizierung verlieren. Fortfahren? (j/N)
    .yes =
        Ja
        ja
        J
